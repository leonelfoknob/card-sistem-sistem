...
query = f"INSERT INTO ogrenci_kayitlari (isim,soyisim,sinif,ogrenci_no,kart_no) VALUES ('{ogrenci_isim}','{ogrenci_soyisim}','{ogrenci_sinif}','{ogrenci_no}','{ogrenci_kart_no}')" #SAVE DATA İN DATABASE
